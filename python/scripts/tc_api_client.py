...
async def call_RB(
    system_instructions, classes, user_message, cache_control, stream, api
):
...
async def test_tc_async_stream(
    ...
    completion, cache_hit = await call_RB(
        system_instructions, classes, user_message, cache_control, True, api
    )
...
async def test_tc_async(
    ...
    completion, cache_hit = await call_RB(
        system_instructions, classes, user_message, cache_control, False, api
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="local",
        help="Set the api host environment (local, dev, prod)",
    )
